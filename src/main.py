...
flywheelStatus = "off"
slowmodeScale = 1
shutdownTime = 
pumpStatus = "on"
shootingMode = "low"
flywheelMode = "fast"
shotBalls = 0
    ...
    while True:
        if RemoteEnabled:
            ...
            if abs(forwardInput) < deadband:
                forwardInput = 0
            if turnInput == 0 and forwardInput == 0:
                desiredHeading = MainGyro.rotation()
            if turnInput == 0:
                currentHeading = MainGyro.rotation()
...
def toggleFlywheelSpeed():
    ...
    global DEFAULTVELOCITY, PASSVELOCITY, MEDSPEED
    global lastPressedTime

    if flywheelMode == "fast":
        flywheelMode = "slow"
        Touch1.set_color(Color.RED)
        flyWheel.set_velocity(PASSVELOCITY, PERCENT)
    elif flywheelMode == "slow":
        Touch1.set_color(Color.GREEN)
        flywheelMode = "fast"
        flyWheel.set_velocity(DEFAULTVELOCITY, PERCENT)

    elif flywheelMode == "med":
        Touch1.set_color(Color.GREEN)
        flywheelMode = "fast"
        flyWheel.set_velocity(DEFAULTVELOCITY, PERCENT)


def ToggleFlywheelSpeed2():
    global flywheelMode, flywheelStatus
    global MEDSPEED
    Touch1.set_color(Color.YELLOW)
    flywheelMode = "med"
    flyWheel.set_velocity(MEDSPEED, PERCENT)
...
def AddSpeed():
    flyWheel.set_velocity(flyWheel.velocity(PERCENT) + 5, PERCENT)
...
ControllerLayoutTables = {
    "Universal": {
        "Buttons": {
            ...
            ButtonBinding(controller.buttonEUp, ToggleFlywheelSpeed2),
            ButtonBinding(controller.buttonEDown, ResetVelocity),
